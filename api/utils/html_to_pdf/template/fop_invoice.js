...
module.exports = (
  ...
  const data = [
    { name: 'name 11111111111111111111111111111111111111111111111111111111111111111', type: 1, amount: 10, price: 1 },
...
<body>
    <div>УВАГА ! Рахунок має бути сплачений протягом 3 банківських днів</div>
        ...
        <div style="display: flex; flex-direction: row; margin-top: 25px">
          ...
          <div style="display: flex; flex-direction: column; margin-left: 15px">SOME CLIENT NAME</div>
        </div>
        ...
        <div style="border: 1px solid black; border-top-width: "
          ...
          {data.map((item, index) => (
            <div key={index} style="display: flex; flex-direction: row">
              <div style="text-align: center; border: 1px solid black; flex: 1">{index}</div>
        ...
        <div style="display: flex; flex-direction: column; padding: 10px">
          ...
          <div>\`${writtenNumber(data.reduce((result, item) => result + item.amount * item.price, 0) * global.pdv, {lang: 'uk'})} грн.\`</div>
          <div>
            ПДВ:{' '}
            {global.pdv
        ...
        <div style="display: flex; justify-content: flex-end; padding: 0 70px">
